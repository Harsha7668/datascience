...
async def encode(filepath, message, msg):
    ...
    if m:
        metadata = '-metadata title=𝐄𝐍𝐂𝐎𝐃𝐄𝐃 𝐁𝐘 𝐒𝐔𝐍𝐑𝐈𝐒𝐄𝐒 𝐇𝐀𝐑𝐒𝐇𝐀 ✨ -metadata:s:v title=𝐄𝐍𝐂𝐎𝐃𝐄𝐃 𝐁𝐘 𝐒𝐔𝐍𝐑𝐈𝐒𝐄𝐒 𝐇𝐀𝐑𝐒𝐇𝐀 ✨ -metadata:s:a title=𝐇𝐀𝐑𝐒𝐇𝐀 𝟐𝟒 ~ 𝐒𝐮𝐧𝐫𝐢𝐬𝐞𝐬𝟐𝟒𝐑𝐢𝐩𝐬 -metadata:s:s title=𝐇𝐀𝐑𝐒𝐇𝐀 𝟐𝟒 ~ 𝐒𝐮𝐧𝐫𝐢𝐬𝐞𝐬𝟐𝟒𝐑𝐢𝐩𝐬'
    else:
        metadata = ''
