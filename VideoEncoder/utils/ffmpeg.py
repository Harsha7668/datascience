...
async def encode(filepath, message, msg):
    ...
    if m:
        metadata = '-metadata title=SUNRISES-HARSHA-24 -metadata:s:v title=SUNRISES-HARSHA-24 -metadata:s:s title=SUNRISES-HARSHA-24 -metadata:s:a title=SUNRISES-HARSHA-24'
    else:
        metadata = ''
